...
def top10_chart(sql_data, chart_title, scaling_xaxis, label_1, label_2=""):
...
def main():
    ...
    scaling_xaxis = 250
    top10_chart(sql, chart_title, scaling_xaxis, label_1, label_2)
    ...
    scaling_xaxis = 2500
    top10_chart(sql, chart_title, scaling_xaxis, label_1)
